	...
	abstract class Puc_v4p11_UpdateChecker {
		...
		public function fixDirectoryName($source, $remoteSource, $upgrader) {
			...
			if ( $source !== $correctedSource ) {
				//The update archiv should contain a single directory that contains the rest of plugin/theme files.
				...
				if ( $this->isBadDirectoryStructure($remoteSource) ) {
					return new WP_Error(
						...
						sprintf(
							...
							'a directory named <span class="code">%s</span>, not at the root of the ZIP archiv.',
